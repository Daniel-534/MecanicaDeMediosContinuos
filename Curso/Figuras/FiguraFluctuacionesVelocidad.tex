...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[>=Latex, font=\small]
        ...
        \node[align=center,fill=white,rounded corners=2pt,
              draw=green!35!black,inner sep=4pt] at (2.7,-0.55)
            {$\displaystyle \vec v_{\mathrm{CM}}
              =\frac{1}{N}\sum_{i=1}^{N}\vec v_i$\\[4pt]
             movimiento aleatorio $+$ flujo medio};
        ...
        \begin{axis}[
            ...
            \node[anchor=west,fill=white,inner sep=2pt]
                at (axis cs:0.03,2.45) {valor medio $v$};

            \draw[<->,thick,orange!85!black]
                (axis cs:-0.35,0.38)--node[below]{$\Delta v$}
                (axis cs:0.35,0.38);
