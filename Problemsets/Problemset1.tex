...
\subsubsection{(a) Condición sobre \texorpdfstring{$N$}{N}}
...
\subsubsection{(b) Estimación de \texorpdfstring{$L_{micro}$}{Lmicro} para el aire}
...
\subsubsection{(a) Probabilidad de encontrar \texorpdfstring{$m$}{m} moléculas}
